...
@Observable
final class QueryGenerateViewModel {
  var outputText = ""
...
extension QueryGenerateViewModel {
  func generateQuery(inputText: String) async {
    await MainActor.run {
      inProgress = true
      errorMessage = nil
      outputText = ""
    ...
    do {
      ...
      for try await outputContent in outputContentStream {
        guard let line = outputContent.text else { return }
